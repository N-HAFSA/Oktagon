...
public class PlayerController : MonoBehaviour {
	...
	void Update () {
        //limit mouvement
        /*transform.position = new Vector3(Mathf.Clamp(transform.position.x,- 9f, 0.0f),
            Mathf.Clamp(transform.position.x,- 5f, 0.0f), 0.0f);*/
    ...
    private void HandleMouvement(float horizontal)
    {
           ...
           // rigidbody.velocity = new Vector3(horizontal * mvtSpeed, rigidbody.velocity.y  );
            Debug.Log("walking");
