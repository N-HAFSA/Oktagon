...
/*    private void OnTriggerEnter2D(Collider2D collider)
    ...
    /* void Update()
     {
         float horizontal = Input.GetAxis("Horizontal");
         //shoting arrow
         if ((Input.GetMouseButtonDown(0) || Input.GetKey(KeyCode.UpArrow)) && shouldMove)
         {
     ...
     {
         rigidbody.velocity =new Vector2(horizontal*mvtSpeed,rigidbody.velocity.y);
         animator.SetFloat("speed", Mathf.Abs( horizontal) );
         Vector2 shootDirectionVector = new Vector2(horizontal, Input.GetAxis("Vertical"));
    ...
    private void HandleMouvement(float horizontal)
    {
